# Map Replacement Instructions (Only `/map`)

Replace **only** the contents of the `/map` folder.

## Checklist

- [ ] Export your web map from QGIS using qgis2web.
- [ ] Delete everything currently inside `/map`.
- [ ] Copy your qgis2web export files/folders into `/map`.
